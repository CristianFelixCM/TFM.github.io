...
export class ProgramShader {
    ...
    static shaderProgram : any;

    

    static generarShaders(gl : WebGL2RenderingContext){
    ...
    static createShaderProgram(gl : WebGL2RenderingContext) {
    ...
    static attachLocation(gl : WebGL2RenderingContext){
